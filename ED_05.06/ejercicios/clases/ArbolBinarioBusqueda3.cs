...
namespace ejercicios.clases
{
    class ArbolBinarioBusqueda3
    {
        ...
        public int balanceo(NodoAB actual)
        {
            ...
            int alturaIzq = balanceo(actual.izquierdo);
        ...
        {
            if (actual == null) return 0;
            if (actual.izquierdo == null & actual.derecho == null) return actual.numero;

            return sumahojas(actual.izquierdo) + sumahojas(actual.derecho);
